public class Veiculo {
    ...
    public Veiculo(Placa placa, double tamTanque) {
        this.placa = placa;
        this.setTamTanque(tamTanque);
        combustivel = 0;
    }
    ...
    public double abastece(double litros) {
        if (litros > 0.0) {
            double tamTanqueDisponivel = tamTanque - combustivel;

            if (tamTanqueDisponivel >= litros) {
                combustivel += litros;
            } else {
                combustivel += tamTanqueDisponivel;
            }
